...
SpringMVC has it's own slightly altered version of this. It works off the same principals just with a more in depth controller.

\begin{center}    
	\includegraphics[height=6cm, width=10cm]{img/springmvc.png}
\end{center}

\noindent After receiving an HTTP request, DispatcherServlet\cite{Dispatcher} consults the HandlerMapping\cite{HandlerMapping} to call the appropriate Controller. \newline
...
\noindent The DispatcherServlet will take help from ViewResolver to pick up the defined view for the request. \newline 
...
\begin{center}    
	\includegraphics[height=17cm, width=20cm]{img/architecture.png}
\end{center}
